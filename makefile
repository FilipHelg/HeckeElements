...
all: hecke kl_structure_poc kl_structure_bulk kl_structure_bulk_opt kl_structure_bulk_opt_parallel dual_kl_poc dual_kl_bulk dual_kl_reader kl_triple_check kl_triple_check_cached #kl_runtime_sample_estimate
...
clean:
	...
	-del /Q dual_kl_poc.exe 2>nul || if exist dual_kl_poc del /Q dual_kl_poc 2>nul
